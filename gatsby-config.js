...
if (process.env.IG_ACCESS_TOKEN && data.instagram.username && data.instagram.instagram_id) {
  extraPlugins.push({
...
if (data.instagram.username && !process.env.IG_ACCESS_TOKEN) {
  extraPlugins.push({
    resolve: 'gatsby-source-instagram',
    options: {
